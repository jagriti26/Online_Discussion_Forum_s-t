...
$str="SELECT * from question, user where  user.user_id=question.user_id AND question_id=$_GET[qid]";
	...
	{	
		while($row = mysql_fetch_array($result))
		{
			...
			echo "<h4>";
			echo $head;	
			echo "<span class='head'><a href='answer.php?id=$_GET[qid]'><button type='button' class='btn btn-primary'>REPLY</button></a></span>";
			echo "</h4>";
			echo "<span class='box2'>";
			echo "<span class='head'>Question</span>";
...
<?php
	...
	{	
		...
		while($row1 = mysql_fetch_array($result))
		{
			...
			echo "<span class='box2'>";
			echo "<span class='head'>Reply<a href='like.php?id=$row1[answer_id] ' class='view2' ><img src='img/Like.png'width='25' height='25'> $row1[like]</a> <a href='dwdpap.php?id=$_GET[qid]' class='view2'><img src='img/Download.png'width='25' height='25'> </a>
</span>";
